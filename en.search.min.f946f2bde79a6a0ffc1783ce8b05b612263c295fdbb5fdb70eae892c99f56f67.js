...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b4b1ac5b46852f5fe5cdb8ebc26334419f0610a4d1b5228de42fb8ba3a0b54e2.js',function(){input.required=false;search();});}
